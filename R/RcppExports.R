...
min_int_na_cpp <- function(x) {
    .Call('netdiffuseR_min_int_na_cpp', PACKAGE = 'netdiffuseR', x)
}

max_int_na_cpp <- function(x) {
    .Call('netdiffuseR_max_int_na_cpp', PACKAGE = 'netdiffuseR', x)
}
