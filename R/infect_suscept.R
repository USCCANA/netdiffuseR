...
#'
#' @param graph Array of size \eqn{n\times n\times T}{nxnxT} as a dynamic graph
#' @param times Integer vector with times of adoption
#' @param normalize Logical. Whether or not to normalize the outcome
#' @details Normalization, \code{normalize=TRUE}, is applied by dividing the
...
#'
#' @export
#' @return Numeric vector of size \eqn{n}{n}.
#'
