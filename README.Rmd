...
For the case of windows and mac users, they can find binary versions of the package [here](https://github.com/USCCANA/netdiffuseR/releases), [netdiffuseR_1.16.3.29.zip](https://github.com/USCCANA/netdiffuseR/releases/download/v1.16.3.29/netdiffuseR_1.16.3.29.zip), and [netdiffuseR_1.16.3.29.tgz](https://github.com/USCCANA/netdiffuseR/releases/download/v1.16.3.29/netdiffuseR_1.16.3.29.tgz) respectively. They can install this directly as follows:
