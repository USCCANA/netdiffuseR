...
Now we run the test for each city. Observe that we can use the __parallel__ package to speedup the test as we will do in the first two cities using two and four cores respectively (this is done thanks to the __boot__ package).
